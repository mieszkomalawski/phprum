 ...
 */
class Version20170917214052 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_1CBCCC2E126F525E');
        $this->addSql('DROP INDEX IDX_1CBCCC2EBA9156A6');
        $this->addSql('CREATE TEMPORARY TABLE __temp__item_blocked_by AS SELECT item_id, blocking_item_id FROM item_blocked_by');
        $this->addSql('DROP TABLE item_blocked_by');
        $this->addSql('CREATE TABLE item_blocked_by (item_id INTEGER NOT NULL, blocking_item_id INTEGER NOT NULL, PRIMARY KEY(item_id, blocking_item_id), CONSTRAINT FK_1CBCCC2E126F525E FOREIGN KEY (item_id) REFERENCES backlog_items (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1CBCCC2EBA9156A6 FOREIGN KEY (blocking_item_id) REFERENCES backlog_items (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO item_blocked_by (item_id, blocking_item_id) SELECT item_id, blocking_item_id FROM __temp__item_blocked_by');
        $this->addSql('DROP TABLE __temp__item_blocked_by');
