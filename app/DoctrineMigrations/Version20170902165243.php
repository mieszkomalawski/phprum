 ...
 */
class Version20170902165243 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE epics (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('DROP INDEX IDX_157410F08C24077B');
        $this->addSql('DROP INDEX IDX_157410F061220EA6');
        $this->addSql('CREATE TEMPORARY TABLE __temp__backlog_items AS SELECT id, creator_id, sprint_id, name, created_at, estimate, priority, status, image_name FROM backlog_items');
        ...
        $this->addSql('INSERT INTO backlog_items (id, creator_id, sprint_id, name, created_at, estimate, priority, status, image_name) SELECT id, creator_id, sprint_id, name, created_at, estimate, priority, status, image_name FROM __temp__backlog_items');
