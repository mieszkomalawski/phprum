 ...
 */
class Version20170902180634 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__epics AS SELECT id, name, color FROM epics');
        ...
        $this->addSql('INSERT INTO epics (id, name, color) SELECT id, name, color FROM __temp__epics');
